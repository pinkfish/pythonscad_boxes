...
- [x] T247ar Give a compartment pull-out scoop a roll the size of the cut (FR-043c1): `r1` defaults to the scoop's own depth, so the edge sweeps down into the well instead of turning a small radius and dropping straight.
