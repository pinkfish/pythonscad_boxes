...
- **FR-043b3**: A **compartment** finger scoop MUST run from the compartment floor to the **top face of the box**, so its r1 roll merges into the box's top edge. Stopping at the interior ceiling leaves the lid band standing above the cut as a step, and buries the roll inside the wall where it can be neither seen nor felt.
