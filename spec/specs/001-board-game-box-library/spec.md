...
- **FR-044e**: A fillet on a cut MUST be a **roundover of the surrounding face**, not a cove gouged into it. The blend MUST be tangent to the face it emerges on, so the face rolls into the cut; a blend tangent instead to the cut's own wall meets the face at 90° and removes a groove around the opening, which is a defect rather than a smoothing.
