...
3. **Given** a sliding lid box, **When** the box and lid are generated, **Then** the box's stop wall (opposite the open end) carries a dovetail groove matching the two sides — full thickness at the top, half thickness at the bottom — into which the lid's leading end seats, so the closed lid is captured at the back as well as along its sides.
...
- **FR-002e**: A sliding-lid box MUST carry a groove in its **stop wall** (the wall opposite the open end) into which the lid's leading end seats. The back groove MUST be dovetailed exactly like the two sides — the stop wall keeps its full thickness at the top and **half of it** at the bottom — so the lid's leading end is trapped at the back as well as along its sides.
...
- **SC-046**: A sliding box's channel is dovetailed into its stop wall exactly like the two sides — full wall thickness at the top, half thickness at the bottom — so the lid's leading end seats there; and the lid-to-groove clearance is configurable, defaulting to 0.1mm per side.
