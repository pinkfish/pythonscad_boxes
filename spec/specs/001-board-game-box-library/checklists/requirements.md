...
- **Two pairs of requirements contradicted each other.** FR-050's tangent roll against FR-064's alignment plane on a lidded box (resolved by FR-065: the cut is built shorter so the roll finishes below it), and FR-074's rolled base against FR-072's 0.2mm floor dip (resolved by FR-075: the face fillet tapers to zero at the base).
...
- **The vocabulary was unstable** — notch/scoop/cutout/hole/bore used interchangeably and, in FR-006, assigned oppositely to FR-050 — now fixed by FR-006a.
