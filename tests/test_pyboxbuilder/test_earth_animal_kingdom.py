...
"""Tests for the Earth: Animal Kingdom board game insert."""

import unittest

from boxes.earth_animal_kingdom.earth_animal_kingdom import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestEarthAnimalKingdom(unittest.TestCase):
    """Test suite for Earth Animal Kingdom project build and layout."""
