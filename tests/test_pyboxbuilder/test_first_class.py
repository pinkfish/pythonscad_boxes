...
"""Tests for the First Class board game insert."""

import unittest

from boxes.first_class.first_class import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestFirstClass(unittest.TestCase):
    """Test suite for First Class project build and layout."""
