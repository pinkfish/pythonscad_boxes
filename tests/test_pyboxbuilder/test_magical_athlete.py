...
"""Tests for the Magical Athlete board game insert."""

import unittest

from boxes.magical_athlete.magical_athlete import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestMagicalAthlete(unittest.TestCase):
    """Test suite for Magical Athlete project build and layout."""
