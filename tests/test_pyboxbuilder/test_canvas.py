...
"""Tests for the Canvas board game insert."""

import unittest

from boxes.canvas.canvas import (
    box_height,
    box_length,
    box_width,
    project,
