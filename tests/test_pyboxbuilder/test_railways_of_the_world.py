...
"""Tests for the Railways of the World board game insert."""

import unittest

from boxes.railways_of_the_world.railways_of_the_world import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestRailwaysOfTheWorld(unittest.TestCase):
    """Test suite for Railways of the World project build and layout."""

    def test_build_completes(self) -> None:
        """Verify the project builds all pieces without errors."""
        build = project.build()
        self.assertGreater(len(build.pieces), 40)
    ...
    def test_box_labels_present(self) -> None:
        ...
        expected = {
            ...
            "EmptyCityBox2",
            "PlayerBoxTrains_red",
            "PlayerBoxTrains_blue",
            "PlayerBoxTrains_green",
            "PlayerBoxTrains_yellow",
            "PlayerBoxTrains_black",
            "PlayerBoxTrains_purple",
            "PlayerBox_red",
            "PlayerBox_blue",
            "PlayerBox_green",
            "PlayerBox_yellow",
