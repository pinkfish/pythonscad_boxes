...
"""Tests for the Dominion Big Box insert."""

import unittest

from boxes.dominion.dominion import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestDominion(unittest.TestCase):
    """Test suite for Dominion Big Box project build and layout."""
    ...
    def test_box_labels_present(self) -> None:
        ...
        expected = {
            ...
            "TokenTray1_CoinAndDebtTokens",
            "TokenTray2_MatsAndSpecialTokens",
        }
