...
"""Tests for the Pioneer Rails board game insert."""

import unittest

from boxes.pioneer_rails.pioneer_rails import (
    box_height,
    box_length,
    box_width,
    project,
...
class TestPioneerRails(unittest.TestCase):
    """Test suite for Pioneer Rails project build and layout."""
    ...
    def test_box_labels_present(self) -> None:
        ...
        expected = {
            "PencilBox",
            "CardBox_GoalCards",
            "CardBox_PlayingCards",
            "CardBox_ForestCards",
            "CardBox_CompanyCards",
        }
